...
import { Edit, Archive, Trash2, Calendar, Clock, ExternalLink, ChevronDown, ChevronRight, UserPlus } from 'lucide-react';
import MobileJobMenu from './MobileJobMenu';
    ...
    <div className="border rounded-lg hover:shadow-md transition-all duration-200">
      ...
      >
        <div className="flex justify-between items-start">
          ...
          <div className="hidden md:flex space-x-2 ml-4" onClick={(e) => e.stopPropagation()}>
            <Button
              size="sm"
              variant="outline"
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                console.log('Button clicked, job:', job, 'handler:', onAddExistingCandidates);
          ...
          {/* Mobile Menu Button */}
          <div className="md:hidden ml-2" onClick={(e) => e.stopPropagation()}>
            <MobileJobMenu 
              job={job}
                ...
                <div key={round.id} className="bg-white rounded-lg p-4 border">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                    ...
                    >
                      ...
                      <span className="sm:hidden">Screening Sheet</span>
                    </Button>
                  </div>
